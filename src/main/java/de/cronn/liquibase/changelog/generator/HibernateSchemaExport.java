...
// This implementation is based on org.hibernate.tool.hbm2ddl.SchemaExport from the "hibernate-ant"
// dependency.
public class HibernateSchemaExport {
  ...
  protected String exportSchema() {
    ...
    schemaCreator.doCreation(
        metadata,
        new ExecutionOptionsForSchemaExport(config),
        ContributableMatcher.ALL,
        new MetadataSourceDescriptor(),
        new ScriptTargetDescriptor(writer));
  ...
  protected StandardServiceRegistry getServiceRegistry() {
    MetadataImplementor metadata =
        (MetadataImplementor) HibernateIntegratorForSchemaExport.getMetadata();
